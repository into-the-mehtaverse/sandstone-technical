...
def get_search_service(store: DocumentStore = Depends(get_store)) -> SearchService:
    """Search service backed by the store. Use in routes via Depends(get_search_service)."""
